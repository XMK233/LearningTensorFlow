...
def main(_):
    ...
    training_config = tf.estimator.RunConfig(
        model_dir= modelDir,    #FLAGS.model_dir
    ...
    classifier.export_savedmodel(exportDir, serving_input_receiver_fn=serving_input_receiver_fn) #FLAGS.export_dir,
